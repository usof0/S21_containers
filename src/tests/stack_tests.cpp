...
TEST(stack_insert_many_back, case2) {
  s21::stack<int> s21_stack_int;
  s21::stack<double> s21_stack_double;
  s21::stack<std::string> s21_stack_string;

  s21_stack_int.insert_many_back(255, 256, 257);
  s21_stack_double.insert_many_back(255.0, 255.3, 255.5);
  s21_stack_string.insert_many_back("255", "abc", "def");

  EXPECT_EQ(s21_stack_int.top(), 257);
  EXPECT_EQ(s21_stack_double.top(), 255.5);
  EXPECT_EQ(s21_stack_string.top(), "def");
}
