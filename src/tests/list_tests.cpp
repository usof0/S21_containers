...
TEST(List, Constructor_Move) {
  s21::List<int> our_list = {1, 2, 3};
  std::list<int> std_list = {1, 2, 3};
  s21::List<int> our_copy(s21::move(our_list));
...
TEST(List, Swap) {
  ...
  s21::List<int> our_list_second = {5, 4, 3, 2, 1};
  std::list<int> std_list_first = {1, 2, 3, 4, 5};
  std::list<int> std_list_second = {5, 4, 3, 2, 1};
...
TEST(List, Unique) {
  s21::List<int> our_list = {1, 1, 1, 2, 2, 2, 2, 3, 4, 5, 6, 6, 6, 6, 7, 7};
  std::list<int> std_list = {1, 1, 1, 2, 2, 2, 2, 3, 4, 5, 6, 6, 6, 6, 7, 7};
  s21::List<int>::iterator our_it;
  std::list<int>::iterator std_it;
  our_list.unique();
  std_list.unique();
